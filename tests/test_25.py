...
"""
Test Advent of Code solutions for day 25
"""

import unittest

import helpers
import day25 as current_day


DAY = 25

EXAMPLE_RESULTS = 58, None
PUZZLE_RESULTS = 435, None
...
class TestExample(unittest.TestCase, helpers.TestMixin):
    ...
    """Day 25: Test solutions using the example"""
    ...
    def test_1(self):
        """Day 25: Test part 1 with example data"""
        self.do_equality_test(0)

    def test_2(self):
        """Day 25: Test part 2 with example data"""
        self.do_equality_test(1)


class TestPuzzle(unittest.TestCase, helpers.TestMixin):

    """Day 25: Test solutions using the puzzle"""
    ...
    def test_1(self):
        """Day 25: Test part 1 with puzzle data"""
        self.do_equality_test(0)

    def test_2(self):
        """Day 25: Test part 2 with puzzle data"""
        self.do_equality_test(1)
