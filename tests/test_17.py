...
"""
Test Advent of Code solutions for day 17
"""

import unittest

import helpers
import day17 as current_day


DAY = 17

EXAMPLE_RESULTS = 45, 112
PUZZLE_RESULTS = 17766, 1733
...
class TestExample(unittest.TestCase, helpers.TestMixin):
    ...
    """Day 17: Test solutions using the example"""
    ...
    def test_1(self):
        """Day 17: Test part 1 with example data"""
        self.do_equality_test(0)

    def test_2(self):
        """Day 17: Test part 2 with example data"""
        self.do_equality_test(1)


class TestPuzzle(unittest.TestCase, helpers.TestMixin):

    """Day 17: Test solutions using the puzzle"""
    ...
    def test_1(self):
        """Day 17: Test part 1 with puzzle data"""
        self.do_equality_test(0)

    def test_2(self):
        """Day 17: Test part 2 with puzzle data"""
        self.do_equality_test(1)
