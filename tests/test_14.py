...
"""
Test Advent of Code solutions for day 14
"""

import unittest

import helpers
import day14 as current_day


DAY = 14

EXAMPLE_RESULTS = 1588, 2188189693529
PUZZLE_RESULTS = 2915, 3353146900153
...
class TestExample(unittest.TestCase, helpers.TestMixin):
    ...
    """Day 14: Test solutions using the example"""
    ...
    def test_1(self):
        """Day 14: Test part 1 with example data"""
        self.do_equality_test(0)

    def test_2(self):
        """Day 14: Test part 2 with example data"""
        self.do_equality_test(1)


class TestPuzzle(unittest.TestCase, helpers.TestMixin):

    """Day 14: Test solutions using the puzzle"""
    ...
    def test_1(self):
        """Day 14: Test part 1 with puzzle data"""
        self.do_equality_test(0)

    def test_2(self):
        """Day 14: Test part 2 with puzzle data"""
        self.do_equality_test(1)
